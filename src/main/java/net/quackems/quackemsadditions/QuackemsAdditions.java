package net.quackems.quackemsadditions;
...
@Mod(QuackemsAdditions.MOD_ID)
public class QuackemsAdditions
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "quackemsadditions";

    // Directly reference a slf4j logger
    public static final Logger LOGGER = LogUtils.getLogger();

    public QuackemsAdditions() {
